...
public class DelayReplicaTest {
    ...
    private static final String minDelay = "250";
    private static final String maxDelay = "250";
    ...
    public void baseTest() {
        try {
            ...
            // Read of client1 of resource written by client1 (x)
            ...
            // Read of client2 of resource written by client2 (x)
